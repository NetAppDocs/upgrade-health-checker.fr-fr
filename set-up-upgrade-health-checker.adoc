...
* Système d'exploitation recommandé : tout système d'exploitation Linux doté de la bibliothèque glibc version 2.28 ou supérieure pour une compatibilité optimale. Cela inclut :
+
** Ubuntu 22.04
** RHEL8
** RHEL9
...
De plus, assurez-vous que la machine virtuelle peut se connecter au point de terminaison de télémétrie (https://support.netapp.com/[] et  https://api.activeiq.netapp.com[]) via HTTPS pour permettre à NetApp de recevoir des informations AutoSupport concernant vos plans de mise à niveau.
