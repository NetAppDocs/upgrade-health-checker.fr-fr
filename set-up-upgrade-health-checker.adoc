...
De plus, assurez-vous que la machine virtuelle peut se connecter au point de terminaison de télémétrie (+https://support.netapp.com+/ et +https://api.activeiq.netapp.com+) via HTTPS pour permettre à NetApp de recevoir des informations AutoSupport sur vos plans de mise à niveau.
